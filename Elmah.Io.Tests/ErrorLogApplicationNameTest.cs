...
namespace Elmah.Io.Tests
{
    public class ErrorLogApplicationNameTest
    {
        ...
        public void CanSetApplicationName()
        {
            ...
            var errorLog = new ErrorLog(new Hashtable {{"applicationName", applicationName}, {"LogId", Guid.NewGuid().ToString()}});
        ...
        {
            var errorLog = new ErrorLog(new Hashtable {{"LogId", Guid.NewGuid().ToString()}});
